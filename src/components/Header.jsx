...
export default function Header() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            //스크롤의 위치가 80이상이면 isScrolled true로 변경하여
        ...
        <header className={isScrolled ? "active" : ""}>
            <div className="inner">
                <div className="header-left">
                    <h1 className="logo">
                        <Link to="/"><img src="./images/logo.svg" alt="logo" /></Link></h1>
                    <nav>
                    ...
                    <ul className="gnb-list">
                        {user ? (
                            <>
                                <li>
                                    <Link to="/userinfo">
                                        <img src="./images/loginMember.png" alt="login" />
                                        <span>내정보</span>
                                    </Link>
                                </li>
                                <li>
