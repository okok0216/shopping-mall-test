...
export default function Cart() {
    ...
    console.log("선택한 항목을 표시할key", checkedItems);
                ...
                <div className="cart-wrap">
                    ...
                    <div className="cart-list-wrap">
                        ...
                        <div className="cart-bottom">
                            {/* <p>총금액:{totalPrice}</p> */}
                            <p>총급액 : {selectedTotal}</p>
                            {/* 선택된아이템,선택한아이템 합계를 결제로 넘기기 */}
